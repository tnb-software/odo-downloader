...
`mvn org.jboss.fuse.odo:odo-downloader-maven-plugin:<version>:download`

or

`mvn org.jboss.fuse.odo:odo-downloader-maven-plugin:<version>:download -Dodo.target.file=/tmp/my-custom-path/odo`
